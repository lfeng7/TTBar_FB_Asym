...
parameters.append(['mu',	0.10, -0.10, 0.30])
parameters.append(['d',		0.10, -0.10, 0.30])
...
initial_templates_filename = TEMPLATE_FILE_NAME+'_initial.root'
refined_templates_filename = TEMPLATE_FILE_NAME+'_refined.root'
