...
config.JobType.psetName = '/uscms_data/d3/eminizer/ttbar_run2/CMSSW_7_2_0/src/Analysis/NTuplizer/python/b2g_miniAod_to_EDMtuple.py'
config.JobType.pluginName = 'Analysis'
config.JobType.pyCfgParams = ['useData=0', 'ignoreTrigger=1', 'muOrEle=0']
