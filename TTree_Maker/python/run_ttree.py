...
parser.add_option('--on_grid', 	  type='string', action='store', default='yes',	  dest='on_grid',	  help='Changes everything to relative paths if running on the grid, default is "yes"')
...
filename+='_tree.root'
#Initialize analyzer
analyzer = treemaker(filename, options.data, options.event_type, options.sideband, options.leptons, options.cross_section/options.n_events)
