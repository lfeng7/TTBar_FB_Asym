...
parser.add_option('-et', '--event_type',  type='string', action='store', default='none',  dest='event_type',  help='ttbar event type: "qq_semilep","gg_semilep","dilep", or "had", or "none" for background files (default "none")')
parser.add_option('-sb', '--sideband',	  type='string', action='store', default='no',    dest='sideband',    help='Perform analysis in a sideband? "yes" or "no" (default: "no")')
parser.add_option('-l',  '--leptons', 	  type='string', action='store', default='muons', dest='leptons',	  help='Specify "muons" or "electrons" lepton type, default is "muons"')
